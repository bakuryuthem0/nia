...
.bg-primary:hover {
  background-color: #286090;
   ...
   <body style="font-family:'Roboto','san serif';padding:2em 4em;">
      <img src="http://preview.Nia Boutique.com/public/images/logo-01.png" style="width:20%;">
      <div>
      	<legend>Correo de contacto</legend>
         <ul>
            <li>Este mensaje le fue enviado mediante el modulo de contacto en <strong>Nia Boutique.com</strong>.</li>
         </ul>
