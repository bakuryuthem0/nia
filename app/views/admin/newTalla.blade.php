	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="col-xs-8 contCentrado" style="margin-top:2em;">
				...
				<form action="{{ URL::to('talla/nueva/enviar') }}" id="formRegister" method="POST" enctype="multipart/form-data">
					<div class="col-xs-12 formulario textoNegro">
						...
						<div class="col-xs-12 inputRegister">
							{{ Form::text('name_talla', Input::old('name_talla'),array('data-trigger' => "blur",'class' => 'form-control cat_nomb inputForm inputFondoNegro','placeholder' => 'Talla',)) }}
					...
					<div class="col-xs-12 formulario textoNegro">
						...
						<div class="col-xs-12 inputRegister">
							{{ Form::text('desc_talla',Input::old('desc_talla'),array('class' => 'form-control inputForm cat_desc inputFondoNegro','placeholder' => 'Descripción de la talla')) }}
